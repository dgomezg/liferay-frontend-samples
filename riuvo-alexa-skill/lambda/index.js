...
const url = `${process.env.BACKEND_SERVER}/o/headless-delivery/v1.0/content-sets/40950/content-set-elements?fields=content.title`
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome to Riuvo cars, you can ask me for available cars for rental or to buy. What do you want to do?';
...
const AvailableCarsIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        const speakOutput = 'You can rent one of the following cars ' 
